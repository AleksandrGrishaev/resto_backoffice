<!-- src/views/kitchen/inventory/components/KitchenPreparationItemRow.vue -->
<!-- Touch-optimized preparation inventory item row for Kitchen/Bar Monitor -->
<template>
  <v-card variant="outlined" class="preparation-item-row mb-3" :class="rowClass">
    <v-card-text class="pa-4">
      <v-row align="center" no-gutters>
        <!-- Item Info -->
        <v-col cols="6" sm="3" class="mb-3 mb-sm-0">
          <div class="d-flex align-center">
            <div class="item-icon mr-3">{{ itemIcon }}</div>
            <div class="item-info">
        ...
        <v-col cols="2" sm="1" class="text-center mb-3 mb-sm-0">
          <div class="status-column">
            <v-icon v-if="isConfirmed" size="24" color="success">mdi-check-circle</v-icon>
            <v-icon v-else size="24" color="grey-lighten-1">mdi-circle-outline</v-icon>
          </div>
        </v-col>
      ...
      <v-expand-transition>
        <div v-if="showNotes" class="notes-section mt-4">
          <v-textarea
            ...
            rows="2"
            density="compact"
            placeholder="Add notes about this preparation..."
