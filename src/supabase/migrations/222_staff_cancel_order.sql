-- Migration: 222_staff_cancel_order
-- Description: Add staff_cancel_order RPC + fix create_online_order to populate customer name from customers table
-- Date: 2026-03-16

-- ========== 1. staff_cancel_order RPC ==========
...
-- ========== 2. Fix create_online_order — populate customer name/phone from customers table ==========
