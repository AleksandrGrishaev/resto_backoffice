-- Migration: 229_fix_online_order_modifier_composition
-- Description: Fix create_online_order RPC to include composition, groupType,
--              isDefault, and targetComponents in selected_modifiers JSONB.
--              Without these fields, DecompositionEngine cannot write off ingredients
--              for online orders (e.g., Custom Breakfast with addon modifiers).
-- Date: 2026-03-17
...
-- ============================================================
-- Also fix update_online_order (same missing fields)
-- ============================================================
