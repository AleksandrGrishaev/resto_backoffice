-- Migration: 271_rpc_merge_customers
-- Description: RPC to merge duplicate customer records
-- Date: 2026-03-30

-- Merges source customer into target:
-- 1. Transfers orders, loyalty_transactions, loyalty_points, stamp_cards, identities, invites
-- 2. Sums balances and stats
-- 3. Fills missing contact info from source
-- 4. Marks source as status='merged', merged_into=target_id
