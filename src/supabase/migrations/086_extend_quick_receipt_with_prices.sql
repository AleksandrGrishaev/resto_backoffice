-- Migration: 086_extend_quick_receipt_with_prices
-- Description: Extend create_quick_receipt_complete RPC with batch price updates
-- Date: 2026-01-02
-- Author: Claude Code
-- Related: Migration 079 (original RPC), Migration 026 (pattern reference)

-- CONTEXT:
-- Current implementation has N+1 performance bottleneck:
-- - 10 items → 10 sequential UPDATEs to products.last_known_cost
-- - 10 items → 10 sequential UPDATEs to package_options prices
-- - Total: 20+ sequential DB calls = 7-10 seconds
--
-- This migration adds batch price updates to the RPC for 5-7x performance improvement.
