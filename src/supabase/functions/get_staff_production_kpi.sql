-- RPC: get_staff_production_kpi
-- Aggregates production_schedule by staff_member for a date range.
-- Returns per-staff metrics: tasks, quantities, durations, photos, quick completions.
-- Also returns overall summary row with staff_member_id = NULL.
